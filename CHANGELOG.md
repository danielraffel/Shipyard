...
- feat/refresh branch policy ([#617](https://github.com/danielraffel/Shipyard/pull/617))
- feat/queue rearm unimplicated batch ([#614](https://github.com/danielraffel/Shipyard/pull/614))
- feat/auto arm and attributed rearm ([#615](https://github.com/danielraffel/Shipyard/pull/615))

<a id="v02140"></a>
## [0.214.0] - 2026-09-25

- feat/metrics gate cost ([#616](https://github.com/danielraffel/Shipyard/pull/616))
...
- feat/landing test tier receipt decisions ([#612](https://github.com/danielraffel/Shipyard/pull/612))

<a id="v02120"></a>
## [0.212.0] - 2026-09-24

- feat/queue reap superseded merge group ([#610](https://github.com/danielraffel/Shipyard/pull/610))
...
- feat/release fleet rollout 20260923 ([#607](https://github.com/danielraffel/Shipyard/pull/607))

<a id="v02091"></a>
## [0.209.1] - 2026-09-23

- chore/bump 0.210.0 20260923 ([#608](https://github.com/danielraffel/Shipyard/pull/608))
- fix/ghapp identity binding 20260923 ([#606](https://github.com/danielraffel/Shipyard/pull/606))

<a id="v02090"></a>
## [0.209.0] - 2026-09-23

- feat/queue state classifier 20260922 ([#605](https://github.com/danielraffel/Shipyard/pull/605))
...
- fix(ship-state): reconcile a flagged record against the PR it names ([#590](https://github.com/danielraffel/Shipyard/pull/590))
...
- fix(steward): let a mixed-case repo slug reach the legacy PR fallback ([#585](https://github.com/danielraffel/Shipyard/pull/585))

<a id="v01981"></a>
## [0.198.1] - 2026-09-06

- fix(ship-state): bound the PR-lock read so contention is nameable ([#584](https://github.com/danielraffel/Shipyard/pull/584))
...
- feat(fleet): reconcile a host-health claim against evidence of service ([#578](https://github.com/danielraffel/Shipyard/pull/578))
...
- fix: canonicalize webhook repository identities (#553) ([#554](https://github.com/danielraffel/Shipyard/pull/554))
- fix: canonicalize webhook repository identities ([#553](https://github.com/danielraffel/Shipyard/pull/553))
...
- fix/terminal reconcile null base ref 20260902 ([#546](https://github.com/danielraffel/Shipyard/pull/546))

<a id="v01521"></a>
## [0.152.1] - 2026-09-01

- release/v0.152.1 20260902 ([#545](https://github.com/danielraffel/Shipyard/pull/545))
- fix/terminal reconcile unbound closed head final 20260901 ([#542](https://github.com/danielraffel/Shipyard/pull/542))

<a id="v01520"></a>
## [0.152.0] - 2026-09-01

- fix(daemon): canonicalize repository policy identity ([#544](https://github.com/danielraffel/Shipyard/pull/544))
...
- feat(metrics): add stewardship scorecard ([#539](https://github.com/danielraffel/Shipyard/pull/539))
...
- feat(wait): track durable Shipyard jobs ([#537](https://github.com/danielraffel/Shipyard/pull/537))

<a id="v01481"></a>
## [0.148.1] - 2026-09-01

- fix(wait): stop terminal-red PR subscriptions ([#536](https://github.com/danielraffel/Shipyard/pull/536))

<a id="v01480"></a>
## [0.148.0] - 2026-09-01

- fix(work-ledger): reconcile authentic schema 11 publication ([#535](https://github.com/danielraffel/Shipyard/pull/535))
...
- feature/dispatch wedge detection 20260831 ([#531](https://github.com/danielraffel/Shipyard/pull/531))
...
- fix/fleet status observation deadline 20260901 ([#532](https://github.com/danielraffel/Shipyard/pull/532))
...
- fix(work-ledger): inventory schema v11 immutably ([#524](https://github.com/danielraffel/Shipyard/pull/524))
...
- fix: stabilize coverage checkout and process teardown ([#520](https://github.com/danielraffel/Shipyard/pull/520))
...
- fix/pr close guard 20260830 ([#513](https://github.com/danielraffel/Shipyard/pull/513))

<a id="v01340"></a>
## [0.134.0] - 2026-08-30

- fix/fleet auth reader atomicity current 20260830 ([#514](https://github.com/danielraffel/Shipyard/pull/514))
...
- investigate/sandbox canary cleanup 20260830 ([#510](https://github.com/danielraffel/Shipyard/pull/510))
...
- fix(auth): preserve privileged binaries on import ([#508](https://github.com/danielraffel/Shipyard/pull/508))
...
- fix(runner): bind and bound admission observation ([#505](https://github.com/danielraffel/Shipyard/pull/505))
...
- fix: release capacity after exact-head merge ([#492](https://github.com/danielraffel/Shipyard/pull/492))

<a id="v01261"></a>
## [0.126.1] - 2026-08-27

- test: stabilize failed installer download fixture ([#487](https://github.com/danielraffel/Shipyard/pull/487))

<a id="v01260"></a>
## [0.126.0] - 2026-08-27

- fix: bind agent adapters to durable routes ([#486](https://github.com/danielraffel/Shipyard/pull/486))
...
- feat: persist provider-neutral launch profiles ([#484](https://github.com/danielraffel/Shipyard/pull/484))

<a id="v01230"></a>
## [0.123.0] - 2026-08-27

- feat: persist durable terminal stewardship handoffs ([#483](https://github.com/danielraffel/Shipyard/pull/483))
...
- feat: add zero-native metadata authority ([#481](https://github.com/danielraffel/Shipyard/pull/481))

<a id="v01200"></a>
## [0.120.0] - 2026-08-26

- fix/ship pr head guard 20260826 ([#480](https://github.com/danielraffel/Shipyard/pull/480))

<a id="v01191"></a>
## [0.119.1] - 2026-08-26

- fix/runner path audit 20260826 ([#479](https://github.com/danielraffel/Shipyard/pull/479))
...
- feature/verified build tree restore 20260825 ([#476](https://github.com/danielraffel/Shipyard/pull/476))
...
- fix/quiet process not stuck 20260825 ([#474](https://github.com/danielraffel/Shipyard/pull/474))
- feature/ctest inventory producer 20260825 ([#473](https://github.com/danielraffel/Shipyard/pull/473))
...
- feat: verify changed-surface shadow trials ([#470](https://github.com/danielraffel/Shipyard/pull/470))
...
- fix(update): refresh daemon through installed binary ([#466](https://github.com/danielraffel/Shipyard/pull/466))
...
- feature/changed surface selected build v3 20260822 ([#460](https://github.com/danielraffel/Shipyard/pull/460))
...
- feat: add bounded pre-push selector receipts ([#455](https://github.com/danielraffel/Shipyard/pull/455))
...
- fix/queue absent recovery 20260821 ([#452](https://github.com/danielraffel/Shipyard/pull/452))

<a id="v01040"></a>
## [0.104.0] - 2026-08-21

- feature/pulp dependency channels 20260821 ([#453](https://github.com/danielraffel/Shipyard/pull/453))

<a id="v01030"></a>
## [0.103.0] - 2026-08-21

- feature/stacked pr observe 20260821 ([#451](https://github.com/danielraffel/Shipyard/pull/451))

<a id="v01020"></a>
## [0.102.0] - 2026-08-21

- feature/spark first line steward 20260821 ([#450](https://github.com/danielraffel/Shipyard/pull/450))
...
- feat(update): harden governed fleet rollout ([#448](https://github.com/danielraffel/Shipyard/pull/448))

<a id="v0990"></a>
## [0.99.0] - 2026-08-21

- fix(state): preserve repository identity in CLI ([#445](https://github.com/danielraffel/Shipyard/pull/445))
...
- feat(execution): make queued work daemon-owned ([#441](https://github.com/danielraffel/Shipyard/pull/441))

<a id="v0961"></a>
## [0.96.1] - 2026-08-20

- fix/fleet offline prevention ([#438](https://github.com/danielraffel/Shipyard/pull/438))
...
- fix(wait): materialize missing required checks ([#424](https://github.com/danielraffel/Shipyard/pull/424))
- docs(runner): keep offline-busy recovery fail-closed ([#423](https://github.com/danielraffel/Shipyard/pull/423))
...
- Record independent activation review ([#376](https://github.com/danielraffel/Shipyard/pull/376))
...
- feat(ship): opt-in same-backend transient retry for local INFRA legs ([#368](https://github.com/danielraffel/Shipyard/pull/368))
...
- fix: address Codex review findings on v0.53.0 → v0.56.0 PRs ([#297](https://github.com/danielraffel/Shipyard/pull/297))
...
- ssh-windows: post-upload bundle probe (#247) ([#251](https://github.com/danielraffel/Shipyard/pull/251))

<a id="v0480"></a>
## [0.48.0] - 2026-04-24

- shipyard run: tree-hash drift detection at stage boundaries (#249) ([#250](https://github.com/danielraffel/Shipyard/pull/250))
- pin bump: check git fetch return code (#245 Codex P2) ([#246](https://github.com/danielraffel/Shipyard/pull/246))
- pin bump: worktree-safety guards (#243) ([#245](https://github.com/danielraffel/Shipyard/pull/245))
...
[0.102.0]: https://github.com/danielraffel/Shipyard/releases/tag/v0.102.0
...
[0.91.2]: https://github.com/danielraffel/Shipyard/releases/tag/v0.91.2
