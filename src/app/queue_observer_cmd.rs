...
mod tests {
    ...
    fn snapshot_transport_is_one_read_only_graphql_query() {
        ...
        for field in [
            ...
            // Merge-group check runs carry the receipt-decision / test-tier
            // annotations; pull-request heads deliberately do not request them.
