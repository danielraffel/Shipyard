...
pub(crate) struct CustodySuccessorRebind {
    ...
    pub(crate) ownership_lease_id: String,
    pub(crate) ownership_lease_generation: u64,
    pub(crate) ownership_lease_expires_at: DateTime<Utc>,
    pub(crate) ownership_root_uuid: String,
    ...
    pub(crate) workstream_handle: String,
    pub(crate) successor_holder_ref: String,
    pub(crate) successor_session_incarnation_ref: String,
